...
public class SecurityController implements Constants {
    ...
    private Region<SecurityKey, SecurityPriceStatus> securityPriceStatusRegion;
    ...
    public void createSecurity(@RequestParam("id") String id, @RequestParam("description") String desc,
        ...
        SecurityPriceStatus sps = new SecurityPriceStatus(key, new Date(), price);
        securityPriceStatusRegion.putIfAbsent(key, sps);
    }
}
