...
public class XrefCacheListener<K> extends CacheListenerAdapter<K, PdxInstance>implements Declarable {
    ...
    //
    // if (fieldValue == null) {
    // LOG.debug("afterDestroy: field value is null: key={}, fieldName={},
    // inst={}", key, fieldName, inst);
    // } else {
    // LOG.debug("afterDestroy: key={}, fieldValue={}, fieldName={}", key,
    // fieldValue, fieldName);
    // Region<Object, DSLockingHashSet<K>> xrefRegion =
    // RegionHelper.getRegion(xrefRegionName);
    // DSLockingHashSet<K> set = xrefRegion.get(fieldValue, factory);
    // set.remove(key);
    // xrefRegion.put(fieldValue, set);
    // }
    ...
    //
    // Object newFieldValue = newInst == null ? null :
    // newInst.getField(fieldName);
    // Object oldFieldValue = oldInst == null ? null :
    // oldInst.getField(fieldName);
    //
    // LOG.debug("afterUpdate: key={}, fieldName={}, oldFieldValue={},
    // newFieldValue={}", key, fieldName, oldFieldValue,
    // newFieldValue);
    //
    // Region<Object, DSLockingHashSet<K>> xrefRegion =
    // RegionHelper.getRegion(xrefRegionName);
    ...
    // LOG.debug("afterUpdate: xref changed: key={}, oldFieldValue={},
    // newFieldValue={}", key, oldFieldValue,
    // newFieldValue);
    //
    ...
    // } else {
    // LOG.debug("afterUpdate: xref field is the same: key={}, oldFieldValue={},
    // newFieldValue={}", key, oldFieldValue,
    // newFieldValue);
    // }
    // } else if (oldFieldValue != null) {
    // LOG.debug("afterUpdate: xref removed: key={}, oldFieldValue={}", key,
    // oldFieldValue);
    //
    // DSLockingHashSet<K> oldSet = xrefRegion.get(oldFieldValue, factory);
    // oldSet.remove(key);
    ...
    // LOG.debug("afterUpdate: xref added: key={}, newFieldValue={}", key,
    // newFieldValue);
    //
    // DSLockingHashSet<K> newSet = xrefRegion.get(newFieldValue, factory);
    // newSet.add(key);
