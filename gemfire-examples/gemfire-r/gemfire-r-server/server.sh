...
cd server
nohup java -cp $cp -Dgemfire.locators=$hn[10334] -Dgemfire.cache-xml-file=$dir/src/main/config/server-cache.xml org.apache.geode.distributed.ServerLauncher start server &
