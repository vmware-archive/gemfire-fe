...
public class MongoDBCompoundKeyCacheWriter<K, V> implements CacheWriter<K, V>, Declarable {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(MongoDBCompoundKeyCacheWriter.class);
